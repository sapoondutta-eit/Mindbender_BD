...
def main():
    ...
    nwords = load_wordlist("negatve.txt")
...
def stream(ssc, pwords, nwords, duration):
    ...
    kstream = KafkaUtils.createDirectStream(
        ssc, topics = ['stonks'], kafkaParams = {"metadata.broker.list": 'localhost:9092, localhost:9093, localhost:9094'})
    ...
    words = tweets.flatMap(lambda k: k.split(b" "))
    # words.pprint()
